...
CORPUS = ROOT / "Supplementary" / "Supplementary_Data_S3_Systematic_Map_Corpus_5898.csv"
THEME_ASSIGN = ROOT / "Reproducibility" / "financing_theme_assignments.csv"
FIGDIR = ROOT / "Figures"
DERIVED = ROOT / "Supplementary" / "Data_Driven_Visualisation_Tables"
...
signal.to_csv(ROOT/"Supplementary"/"Supplementary_Table_S1_Abstract_Potential_Challenge_Signals.csv",index=False)
...
(ROOT/"Reproducibility"/"data_driven_visualisation_summary.json").write_text(json.dumps(summary,indent=2),encoding="utf-8")
